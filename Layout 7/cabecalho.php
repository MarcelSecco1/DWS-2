...
<body>
    ...
    if (!function_exists("autenticado")) {
        echo "<br><h1>Atenção você esqueceu o require do arquivo \"logica-aut.php\"!</h1>";
        die();
    }
    ?>
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky mt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?= ativa('listagem-galeria.php'); ?>" aria-current="page" href="listagem-galeria.php">
