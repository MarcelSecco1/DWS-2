    ...
    <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start pe-3 d-none d-sm-block">
            <div class="text-end">
                ...
                <a href="formulario-user.php" class="btn btn-warning me-2">
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky mt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?=ativa('listagem-user.php');?>" aria-current="page" href="listagem-user.php">
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link <?=ativa('session_login.php');?>" aria-current="page" href="session_login.php">
                                <span data-feather="log-in"></span>
                                 Log-in
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?=ativa('session_logout.php');?>" aria-current="page" href="session_logout.php">
                                <span data-feather="log-out"></span>
                                 Log-Out
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?=ativa('session_pagina1.php');?>" aria-current="page" href="session_pagina1.php">
                                <?php
                                    if(isset($_SESSION["email"]) && !empty($_SESSION["email"])){
                                        //fez login, está autenticado
                                        ?>
                                        <span data-feather="unlock"></span>
                                        <?php
                                    }else{
                                        //não fez login, não pode acessar
                                        ?>
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?=ativa('session_pagina2.php');?>" aria-current="page" href="session_pagina2.php">
                            <?php
                                    if(isset($_SESSION["email"]) && !empty($_SESSION["email"])){
                                        //fez login, está autenticado
                                        ?>
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?=ativa('session_pagina3.php');?>" aria-current="page" href="session_pagina3.php">
                            <?php
                                    if(isset($_SESSION["email"]) && !empty($_SESSION["email"])){
                                        //fez login, está autenticado
                                        ?>
